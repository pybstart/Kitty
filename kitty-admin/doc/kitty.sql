...
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES ('1975', '刘备', null, 'SysDictServiceImpl.findPage()', '{\"columnFilters\":{\"label\":{\"name\":\"label\",\"value\":\"\"}},\"pageNum\":1,\"pageSize\":8}', '4', '0:0:0:0:0:0:0:1', '刘备', '2018-11-27 17:18:45', null, null);
INSERT INTO `sys_log` VALUES ('1976', '诸葛亮', null, 'SysUserServiceImpl.findPage()', '{\"columnFilters\":{\"name\":{\"name\":\"name\",\"value\":\"\"}},\"pageNum\":1,\"pageSize\":8}', '44', '0:0:0:0:0:0:0:1', '诸葛亮', '2018-11-27 17:18:56', null, null);
INSERT INTO `sys_log` VALUES ('1977', 'admin', null, 'SysUserServiceImpl.findPage()', '{\"columnFilters\":{\"name\":{\"name\":\"name\",\"value\":\"\"}},\"pageNum\":1,\"pageSize\":8}', '41', '0:0:0:0:0:0:0:1', 'admin', '2018-11-27 17:19:04', null, null);
INSERT INTO `sys_log` VALUES ('1978', 'admin', null, 'SysRoleServiceImpl.findPage()', '{\"columnFilters\":{\"name\":{\"name\":\"name\",\"value\":\"\"}},\"pageNum\":1,\"pageSize\":8}', '5', '0:0:0:0:0:0:0:1', 'admin', '2018-11-27 17:19:05', null, null);
INSERT INTO `sys_log` VALUES ('1979', 'admin', null, 'SysDictServiceImpl.findPage()', '{\"columnFilters\":{\"label\":{\"name\":\"label\",\"value\":\"\"}},\"pageNum\":1,\"pageSize\":8}', '24', '0:0:0:0:0:0:0:1', 'admin', '2018-11-27 17:19:06', null, null);
INSERT INTO `sys_log` VALUES ('1980', '刘备', null, 'SysUserServiceImpl.findPage()', '{\"columnFilters\":{\"name\":{\"name\":\"name\",\"value\":\"\"}},\"pageNum\":1,\"pageSize\":8}', '48', '0:0:0:0:0:0:0:1', '刘备', '2018-11-27 17:24:52', null, null);
INSERT INTO `sys_log` VALUES ('1981', '刘备', null, 'SysRoleServiceImpl.findPage()', '{\"columnFilters\":{\"name\":{\"name\":\"name\",\"value\":\"\"}},\"pageNum\":1,\"pageSize\":8}', '4', '0:0:0:0:0:0:0:1', '刘备', '2018-11-27 17:24:53', null, null);
INSERT INTO `sys_log` VALUES ('1982', '刘备', null, 'SysDictServiceImpl.findPage()', '{\"columnFilters\":{\"label\":{\"name\":\"label\",\"value\":\"\"}},\"pageNum\":1,\"pageSize\":8}', '8', '0:0:0:0:0:0:0:1', '刘备', '2018-11-27 17:24:54', null, null);
INSERT INTO `sys_log` VALUES ('1983', 'admin', null, 'SysUserServiceImpl.findPage()', '{\"columnFilters\":{\"name\":{\"name\":\"name\",\"value\":\"\"}},\"pageNum\":1,\"pageSize\":8}', '51', '0:0:0:0:0:0:0:1', 'admin', '2018-11-27 17:26:18', null, null);
INSERT INTO `sys_log` VALUES ('1984', 'admin', null, 'SysRoleServiceImpl.findPage()', '{\"columnFilters\":{\"name\":{\"name\":\"name\",\"value\":\"\"}},\"pageNum\":1,\"pageSize\":8}', '3', '0:0:0:0:0:0:0:1', 'admin', '2018-11-27 17:26:21', null, null);
INSERT INTO `sys_log` VALUES ('1985', 'admin', null, 'SysDictServiceImpl.findPage()', '{\"columnFilters\":{\"label\":{\"name\":\"label\",\"value\":\"\"}},\"pageNum\":1,\"pageSize\":8}', '13', '0:0:0:0:0:0:0:1', 'admin', '2018-11-27 17:26:22', null, null);
INSERT INTO `sys_log` VALUES ('1986', '刘备', null, 'SysUserServiceImpl.findPage()', '{\"columnFilters\":{\"name\":{\"name\":\"name\",\"value\":\"\"}},\"pageNum\":1,\"pageSize\":8}', '41', '0:0:0:0:0:0:0:1', '刘备', '2018-11-27 17:26:41', null, null);
...
CREATE TABLE `sys_user` (
  ...
  `avater` varchar (20) DEFAULT NULL COMMENT '用户头像',
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `last_update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin','adminKitty', 'bd1718f058d8a02468134432b8656a86', 'YzcmCZNvbXocrsz9dm8e', 'admin@qq.com', '13612345678', '1', '4','','', 'admin', '2018-08-14 11:11:11', 'admin', '2018-08-14 11:11:11', '0');
INSERT INTO `sys_user` VALUES ('22', '刘备','LiuBeiKitty', 'df87a112cc5680af676582ccbf25c894', '7f31d587bd1a4ba6b28c', 'test@qq.com', '13889700023', '1', '34', '','', 'admin', '2018-09-23 19:43:00', 'admin', '2018-11-04 10:12:45', '0');
INSERT INTO `sys_user` VALUES ('23', '赵云','ZhaoYunKitty', 'df87a112cc5680af676582ccbf25c894', '7f31d587bd1a4ba6b28c', 'test@qq.com', '13889700023', '1', '34','','',  'admin', '2018-09-23 19:43:44', 'admin', '2018-09-23 19:43:52', '0');
INSERT INTO `sys_user` VALUES ('24', '诸葛亮','ZhuGeKitty','df87a112cc5680af676582ccbf25c894', '7f31d587bd1a4ba6b28c', 'test@qq.com', '13889700023', '1', '34', '','', 'admin', '2018-09-23 19:44:23', 'admin', '2018-09-23 19:44:29', '0');
INSERT INTO `sys_user` VALUES ('25', '曹操','CaoManKitty','df87a112cc5680af676582ccbf25c894', '7f31d587bd1a4ba6b28c', 'test@qq.com', '13889700023', '1', '33', '','', 'admin', '2018-09-23 19:45:32', 'admin', '2018-09-23 19:45:37', '0');
INSERT INTO `sys_user` VALUES ('26', '典韦','DianWeiKitty', 'df87a112cc5680af676582ccbf25c894', '7f31d587bd1a4ba6b28c', 'test@qq.com', '13889700023', '1', '33', '','', 'admin', '2018-09-23 19:45:48', 'admin', '2018-09-23 19:45:57', '0');
INSERT INTO `sys_user` VALUES ('27', '夏侯惇','XiaHouDunKitty' 'df87a112cc5680af676582ccbf25c894', '7f31d587bd1a4ba6b28c', 'test@qq.com', '13889700023', '1', '33', '','', 'admin', '2018-09-23 19:46:09', 'admin', '2018-09-23 19:46:17', '0');
INSERT INTO `sys_user` VALUES ('28', '荀彧','XunYiKitty', 'df87a112cc5680af676582ccbf25c894', '7f31d587bd1a4ba6b28c', 'test@qq.com', '13889700023', '1', '33', '','', 'admin', '2018-09-23 19:46:38', 'admin', '2018-11-04 15:33:17', '0');
INSERT INTO `sys_user` VALUES ('29', '孙权','SunQuanKitty', 'df87a112cc5680af676582ccbf25c894', '7f31d587bd1a4ba6b28c', 'test@qq.com', '13889700023', '1', '35', '','', 'admin', '2018-09-23 19:46:54', 'admin', '2018-09-23 19:47:03', '0');
INSERT INTO `sys_user` VALUES ('30', '周瑜','ZhouYuKitty', 'df87a112cc5680af676582ccbf25c894', '7f31d587bd1a4ba6b28c', 'test@qq.com', '13889700023', '1', '35', '','', 'admin', '2018-09-23 19:47:28', 'admin', '2018-09-23 19:48:04', '0');
INSERT INTO `sys_user` VALUES ('31', '陆逊','LuXunKitty', 'df87a112cc5680af676582ccbf25c894', '7f31d587bd1a4ba6b28c', 'test@qq.com', '13889700023', '1', '35', '','', 'admin', '2018-09-23 19:47:44', 'admin', '2018-09-23 19:47:58', '0');
INSERT INTO `sys_user` VALUES ('32', '黄盖','HuangGaiKitty', 'df87a112cc5680af676582ccbf25c894', '7f31d587bd1a4ba6b28c', 'test@qq.com', '13889700023', '1', '35', '','', 'admin', '2018-09-23 19:48:38', 'admin', '2018-09-23 19:49:02', '0');
